...
public class PersonGenerator {
     ...
     * @throws Exception
     */
    public String[] getNameSexAge(String ageType) throws Exception {
        String sex = this.getSex();
        String name = this.getNameBySex(sex);
        String familyName = this.getFamilyName();
        int age;
        switch (ageType) {
            case "teacher":age = this.getTeacherAge();break;
            case "junior":age = this.getJuniorAge();break;
            case "senior":age = this.getSeniorAge();break;
            default: throw new Exception();
        }
        String[] nameSexAge = new String[3];
        nameSexAge[0] = familyName + name;
        nameSexAge[1] = sex;
        nameSexAge[2] = Integer.toString(age);
        return nameSexAge;
    }
     ...
     * @return
     */
    public String getNameBySex(String sex) {
        int randNum = new Random().nextInt(2) + 1;
    ...
    public int getSeniorAge() {
        return new Random().nextInt(4) + 15;
    }
    ...
    public int getTeacherAge() {
        return new Random().nextInt(28) + 26;
    }
